...
public class Quiz1 extends AppCompatActivity {
    TextView myq1;
    RadioGroup myrg1, myrg2, myrg3, myrg4, myrg5, myrg6, myrg7, myrg8, myrg9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myrg8 = findViewById(R.id.rg8);
        myrg9 = findViewById(R.id.rg9);
        ...
        mysmbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int totalScore = getSelectedValue(myrg1)+ getSelectedValue(myrg2)+
                        ...
                        getSelectedValue(myrg7)+ getSelectedValue(myrg8)+
                        getSelectedValue(myrg9) - 9;
                ...
                if (getSelectedValue(myrg1) == -1 || getSelectedValue(myrg2) == -1
                        ...
                        || getSelectedValue(myrg7) == -1 || getSelectedValue(myrg8) == -1
                        || getSelectedValue(myrg9) == -1) {
                    Toast.makeText(Quiz1.this, "กรุณาเลือกทุกข้อก่อนส่ง", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                // แสดงผล
                Toast.makeText(Quiz1.this, "ท่านได้ส่งแบบทดสอบแล้ว", Toast.LENGTH_SHORT).show();
    ...
    private int getSelectedValue(RadioGroup radioGroup) {
        ...
        return Integer.parseInt(selectedRadioButton.getText().toString()); // คืนค่าที่เลือกเป็น int
    }
}