...
public class Quiz4 extends AppCompatActivity {
    ...
    TextView myq1;
    RadioGroup myrg1, myrg2, myrg3, myrg4, myrg5, myrg6, myrg7, myrg8, myrg9, myrg10;
        ...
        mysmbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int totalScore = getSelectedValue(myrg1)+ getSelectedValue(myrg2)+
                        ...
                        getSelectedValue(myrg9)+ getSelectedValue(myrg10);
                ...
                if (getSelectedValue(myrg1) == -1 || getSelectedValue(myrg2) == -1
                    ...
                    Toast.makeText(Quiz4.this, "กรุณาเลือกทุกข้อก่อนส่ง", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                // แสดงผล
                Toast.makeText(Quiz4.this, "ท่านได้ส่งแบบทดสอบแล้ว", Toast.LENGTH_SHORT).show();

                // ส่งค่าไปหน้า ResultActivity
                Intent intent = new Intent(Quiz4.this, Result.class);
