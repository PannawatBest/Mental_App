        ...
        mysmbt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getSelectedValue(myrg1) == -1 || getSelectedValue(myrg2) == -1
                    ...
                    Toast.makeText(Quiz2.this, "กรุณาเลือกทุกข้อก่อนส่ง", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                // แสดงผล
                Toast.makeText(Quiz2.this, "ท่านได้ส่งแบบทดสอบแล้ว", Toast.LENGTH_SHORT).show();

                // ส่งค่าไปหน้า ResultActivity
                Intent intent = new Intent(Quiz2.this, Result.class);
